...
![Claude Code beginner intro — 6 pages generated by deck-workflow](./assets/claude-code-intro/preview.png)

This repo ships a self-demo built *by* the skill: a 6-page English deck that introduces Claude Code to someone who has never written a line of code. The deck workspace lives at [`assets/claude-code-intro/`](./assets/claude-code-intro), with [`PPT_GUIDE.md`](./assets/claude-code-intro/PPT_GUIDE.md), [`generate_ppt.py`](./assets/claude-code-intro/generate_ppt.py), the final [`ClaudeCode_intro.pptx`](./assets/claude-code-intro/ClaudeCode_intro.pptx), and [per-slide PNG renders](./assets/claude-code-intro/rendered) all side by side.

To reproduce the deck, hand the one-liner below to a Claude Code or Codex session that has `deck-workflow` installed:
...
Individual slides: [01 cover](./assets/claude-code-intro/rendered/slide-001.png) · [02 what it is](./assets/claude-code-intro/rendered/slide-002.png) · [03 how it feels](./assets/claude-code-intro/rendered/slide-003.png) · [04 why it sticks](./assets/claude-code-intro/rendered/slide-004.png) · [05 what you can build](./assets/claude-code-intro/rendered/slide-005.png) · [06 get started](./assets/claude-code-intro/rendered/slide-006.png)
